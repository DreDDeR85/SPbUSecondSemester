...
/// <summary>
/// List, a data structure consisting of elements containing, 
/// in addition to their own data, links to the next list element.
/// </summary>
public class List
{
    /// <summary>
    ...
    /// </summary>
    /// <param name="value"> The value. </param>
    /// <exception cref="RemoveNonexistentElementException"></exception>
    ...
    /// <returns> If the replacement was successful, returns True, otherwise False. </returns>
    ...
    /// </summary>
    /// <returns> If the list is empty return True, otherwise False. </returns>
